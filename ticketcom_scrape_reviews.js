...
async function scrapeReviews() {
    ...
    console.log("Searching for 'Sort' button...");
    ...
    const sortText = await page.$x("//button//span[contains(text(), 'Sort')]");
    ...
    if (sortText.length > 0) {
        ...
        console.log("❌ 'Sort' text not found.");
    }

    console.log("Looking for 'Latest Review'...");
    await page.waitForFunction(() => {
    ...
    while (true) {
        ...
        await nextPageButton.evaluate(btn => btn.click());
        await new Promise(resolve => setTimeout(resolve, 3000));
        pageCounter++;
    }     
